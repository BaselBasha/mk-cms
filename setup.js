...
`;
  ...
  console.log('⚠️  Please update the AWS credentials and JWT_SECRET in .env.local\n');
} else {
...
const requiredDeps = [
  'express', 'mongoose', 'aws-sdk', 'bcryptjs', 'jsonwebtoken',
...
console.log('6. Initialize admin account: curl -X POST http://localhost:3001/api/auth/init');

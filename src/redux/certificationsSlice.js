...
export const createCertification = createAsyncThunk('certifications/create', async (data) => {
  const res = await fetch(ENDPOINTS.certifications, {
    method: 'POST',
...
export const updateCertification = createAsyncThunk('certifications/update', async ({ id, data }) => {
...
export const deleteCertification = createAsyncThunk('certifications/delete', async (id) => {
  const res = await fetch(`${ENDPOINTS.certifications}/${id}`, { method: 'DELETE' });
